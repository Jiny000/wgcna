...
Run WGCNA
```r
Rscript 01_wgcna_step1_filter_exp_matrix.R --input_exp ~/zouGroup/disk2/jyli/fiber_curve/01.Published_data_analysis/02.rsem/02.run_rsem/gene.groupmean.tpm.txt --large_exp 1 --outdir .
